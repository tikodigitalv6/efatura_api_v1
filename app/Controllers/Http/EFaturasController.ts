import type {
  ...
  const DEFAULT_EFATURA_XSLT = String.raw`<?xml version="1.0" encoding="UTF-8"?>
  ...
  const DEFAULT_EFATURA_KODLU_XSLT = String.raw`<?xml version="1.0" encoding="UTF-8"?>
			  <xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				  xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
				  xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2"
				  xmlns:ccts="urn:un:unece:uncefact:documentation:2"
  ...
  const DEFAULT_EIHRACAT_XSLT = String.raw`<?xml version="1.0" encoding="UTF-8"?>
		  ...
		  <table border="0" cellspacing="0px" width="800" cellpadding="0px">
			<tr width="900" height="180" border="0">
			  ...
			  <td width="25%" align="center" valign="middle">
				...
				<img style="width:91px;" align="middle" alt="Gib Logo" src="data:image/jpeg;base64," />
		...
		<table id="notesTable" width="800" align="left" height="100">
		  <tbody>
			<tr align="left">
			  <td id="notesTableTd">
				<xsl:for-each select="//n1:Invoice/cac:TaxTotal/cac:TaxSubtotal">
				  <xsl:if test="(cbc:Percent=0 and cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode=&apos;0015&apos;) or (//n1:Invoice/cbc:InvoiceTypeCode='ISTISNA')">
					<b>Vergi İstisna Muafiyet Sebebi: </b>
					<xsl:value-of select="cac:TaxCategory/cbc:TaxExemptionReason" />
					<br />
				  </xsl:if>
  ...
  export default class EFaturasController {
	...
	private getItemCode(lines: any) {
	  ...
	  return rawItemCode ? String(rawItemCode).trim() : '';
	}
  
	private hasInvoiceLineProductCode(lines: any[] = []) {
	  return Array.isArray(lines) && lines.some((line) => this.getItemCode(line) !== '');
	}
	...
	private getInlineXsltBase64(hasProductCode: boolean, all: any) {
	  const isIhracat = String(all?.ProfileID || '').toUpperCase() === 'IHRACAT';
  
	  let xslt = isIhracat
		? DEFAULT_EIHRACAT_XSLT
		: (hasProductCode ? DEFAULT_EFATURA_KODLU_XSLT : DEFAULT_EFATURA_XSLT);
	...
	private getOrderReferenceXml(all: any) {
	  const rawOrderNo = [
		...
		all?.siparisNo,
		all?.SiparisNo,
		all?.order_reference_id,
		all?.OrderReference?.ID,
		all?.OrderReference?.id,
		all?.orderReference?.ID,
		all?.orderReference?.id,
	  ].find((value) => value !== undefined && value !== null && String(value).trim() !== '');
	  ...
	  const rawOrderDate = [
		...
		all?.siparisTarihi,
		all?.SiparisTarihi,
		all?.order_reference_issue_date,
		all?.OrderReference?.IssueDate,
		all?.OrderReference?.issueDate,
		all?.orderReference?.IssueDate,
		all?.orderReference?.issueDate,
	  ].find((value) => value !== undefined && value !== null && String(value).trim() !== '');
  
	  const orderNo = this.xmlEscape(rawOrderNo ?? '');
	  const orderDate = this.xmlEscape(rawOrderDate ?? '');
  
	  if (!orderNo) return '';
  
	  return `
		<cac:OrderReference>
		  <cbc:ID>${orderNo}</cbc:ID>
		  ${orderDate ? `<cbc:IssueDate>${orderDate}</cbc:IssueDate>` : ``}
		</cac:OrderReference>
	  `;
	}
	public async eFatura({
	  response,
	  request
	}: HttpContextContract) {
	  ...
	  try {
		...
		const inlineXsltBase64 = this.getInlineXsltBase64(hasProductCode, all)
  
		let xslt = inlineXsltBase64;
		...
		for (let nt = 0; nt < all.Note.length; nt++) {
		  ...
		  if (element.note != null) {
			let noteList = ` <cbc:Note>${this.xmlEscape(element.note)}</cbc:Note>`
			note.push(noteList)
		  }
		}
		...
		<cbc:ProfileID>${this.xmlEscape(all.ProfileID)}</cbc:ProfileID>
		<cbc:ID>${this.xmlEscape(all.invoiceID)}</cbc:ID>
		<cbc:CopyIndicator>false</cbc:CopyIndicator>
		<cbc:UUID>${this.xmlEscape(all.uuid)}</cbc:UUID>
		<cbc:IssueDate>${this.xmlEscape(all.IssueDate)}</cbc:IssueDate>
		<cbc:IssueTime>${this.xmlEscape(all.IssueTime)}</cbc:IssueTime>
		<cbc:InvoiceTypeCode>${this.xmlEscape(all.InvoiceTypeCode)}</cbc:InvoiceTypeCode>
		${note.join('')}
		<cbc:DocumentCurrencyCode>${this.xmlEscape(all.currencyID)}</cbc:DocumentCurrencyCode>
		<cbc:LineCountNumeric>${this.xmlEscape(all.LineCountNumeric)}</cbc:LineCountNumeric>
		`
		...
		if (all.DespatchDocumentReference != undefined && all.DespatchDocumentReference.length != 0) {
		  ...
		  for (let dm = 0; dm < all.DespatchDocumentReference.length; dm++) {
			...
			<cac:DespatchDocumentReference>
			  <cbc:ID>${this.xmlEscape(element.ID)}</cbc:ID>
			  <cbc:IssueDate>${this.xmlEscape(element.IssueDate)}</cbc:IssueDate>
			</cac:DespatchDocumentReference>
		  `
		...
		const orderReferenceXml = this.getOrderReferenceXml(all)
  
		let stb = `
		<cac:AdditionalDocumentReference>
		<cbc:ID>${this.xmlEscape(all.uuid)}</cbc:ID>
		<cbc:IssueDate>${this.xmlEscape(all.IssueDate)}</cbc:IssueDate>
		<cbc:DocumentType>XSLT</cbc:DocumentType>
		<cac:Attachment>
		  <cbc:EmbeddedDocumentBinaryObject characterSetCode="UTF-8" encodingCode="Base64" filename="${this.xmlEscape(all.invoiceID)}.xslt" mimeCode="application/xml">`
  
		// XSLT artık controller içinde gömülü gelir.
		// IHRACAT ise ihracat XSLT, değilse ürün koduna göre kodlu/normal XSLT seçilir.
		// Dosya adı veya dışarıdan xml okuma yoktur.
		...
		let Signature = `
		<cac:Signature>
		  <cbc:ID schemeID="VKN_TCKN">${this.xmlEscape(all.SignatureVKN_TCKN)}</cbc:ID>
		  <cac:SignatoryParty>
			<cac:PartyIdentification>
			  <cbc:ID schemeID="VKN">${this.xmlEscape(all.SignatureVKN)}</cbc:ID>
			</cac:PartyIdentification>
			<cac:PostalAddress>
			  <cbc:StreetName>${this.xmlEscape(all.SignatureStreetName)}</cbc:StreetName>
			  <cbc:BuildingName/>
			  <cbc:BuildingNumber>${this.xmlEscape(all.SignatureBuildingNumber)}</cbc:BuildingNumber>
			  <cbc:CitySubdivisionName>${this.xmlEscape(all.SignatureCitySubdivisionName)}</cbc:CitySubdivisionName>
			  <cbc:CityName>${this.xmlEscape(all.SignatureCityName)}</cbc:CityName>
			  <cbc:PostalZone>${this.xmlEscape(all.SignaturePostalZone)}</cbc:PostalZone>
			  <cbc:Region>${this.xmlEscape(all.SignatureRegion)}</cbc:Region>
			  <cac:Country>
				<cbc:Name>${this.xmlEscape(all.SignatureCountryName)}</cbc:Name>
			  </cac:Country>
			</cac:PostalAddress>
		  </cac:SignatoryParty>
		  <cac:DigitalSignatureAttachment>
			<cac:ExternalReference>
			  <cbc:URI>#Signature_${this.xmlEscape(all.invoiceID)}</cbc:URI>
			</cac:ExternalReference>
		  </cac:DigitalSignatureAttachment>
		</cac:Signature>`
		...
		if (all.AspPersonFirstName?.length > 0 && all.AspPersonFamilyName?.length > 0 && all.AspName?.length > 0) {
		  ...
		  firtsAndfamliy = `
		  <cac:Person>
			<cbc:FirstName>${this.xmlEscape(all.AspPersonFirstName)}</cbc:FirstName>
			<cbc:FamilyName>${this.xmlEscape(all.AspPersonFamilyName)}</cbc:FamilyName>
		  </cac:Person>
		  `
  
		  Unvan = `
		  <cac:PartyName>
			<cbc:Name>${this.xmlEscape(all.AspName)}</cbc:Name>
		  </cac:PartyName>
		  `
		...
		let AccountingSupplierParty = `
			  <cac:AccountingSupplierParty>
			  <cac:Party>
				<cbc:WebsiteURI>${this.xmlEscape(all.AspWebsiteURI)}</cbc:WebsiteURI>
				<cac:PartyIdentification>
				  <cbc:ID schemeID="${aspType}">${this.xmlEscape(all.AspVKN)}</cbc:ID>
				</cac:PartyIdentification>
				<cac:PartyIdentification>
				  <cbc:ID schemeID="MERSISNO">${this.xmlEscape(all.AspMERSISNO)}</cbc:ID>
				</cac:PartyIdentification>
				<cac:PartyIdentification>
				  <cbc:ID schemeID="TICARETSICILNO">${this.xmlEscape(all.AspTICARETSICILNO)}</cbc:ID>
				</cac:PartyIdentification>
				  ${Unvan}
				<cac:PostalAddress>
				  <cbc:StreetName>${this.xmlEscape(all.AspStreetName)}</cbc:StreetName>
				  <cbc:BuildingName/>
				  <cbc:BuildingNumber/>
				  <cbc:CitySubdivisionName>${this.xmlEscape(all.AspCitySubdivisionName)}</cbc:CitySubdivisionName>
				  <cbc:CityName>${this.xmlEscape(all.AspCityName)}</cbc:CityName>
				  <cbc:PostalZone>${this.xmlEscape(all.AspPostalZone)}</cbc:PostalZone>
				  <cbc:Region>${this.xmlEscape(all.AspRegion)}</cbc:Region>
				  <cac:Country>
					<cbc:Name>${this.xmlEscape(all.AspCountryName)}</cbc:Name>
				  </cac:Country>
				</cac:PostalAddress>
				<cac:PartyTaxScheme>
				  <cac:TaxScheme>
					<cbc:Name>${this.xmlEscape(all.AspPartyTaxSchemeName)}</cbc:Name>
				  </cac:TaxScheme>
				</cac:PartyTaxScheme>
				<cac:Contact>
				  <cbc:Telephone>${this.xmlEscape(all.AspContactTelephone)}</cbc:Telephone>
				  <cbc:Telefax/>
				  <cbc:ElectronicMail>${this.xmlEscape(all.AspContactElectronicMail)}</cbc:ElectronicMail>
				</cac:Contact>
				${firtsAndfamliy}
			  </cac:Party>
			</cac:AccountingSupplierParty>
		...
		if (all.AcpPersonFirstName?.length > 0 && all.AcpPersonFamilyName?.length > 0 && all.AcpName?.length > 0) {
		  ...
		  acpfirtsAndfamliy = `
		  <cac:Person>
			<cbc:FirstName>${this.xmlEscape(all.AcpPersonFirstName)}</cbc:FirstName>
			<cbc:FamilyName>${this.xmlEscape(all.AcpPersonFamilyName)}</cbc:FamilyName>
		  </cac:Person>
		  `
  
		  acpUnvan = `
		  <cac:PartyName>
			<cbc:Name>${this.xmlEscape(all.AcpName)}</cbc:Name>
		  </cac:PartyName>
		  `
		...
		<cac:Party>
		  <cac:PartyIdentification>
			<cbc:ID schemeID="${acpType}">${this.xmlEscape(all.AcpVKN)}</cbc:ID>
		  </cac:PartyIdentification>
		  ${acpUnvan}
		  <cac:PostalAddress>
			<cbc:StreetName>${this.xmlEscape(all.AcpStreetName)}</cbc:StreetName>
			<cbc:BuildingName/>
			<cbc:BuildingNumber/>
		  ...
		  <cac:PartyTaxScheme>
			<cac:TaxScheme>
			  <cbc:Name>${this.xmlEscape(all.AcpPartyTaxSchemeName)}</cbc:Name>
			</cac:TaxScheme>
		  </cac:PartyTaxScheme>
		  <cac:Contact>
			<cbc:Telephone>${this.xmlEscape(all.AcpContactTelephone)}</cbc:Telephone>
			<cbc:Telefax/>
			<cbc:ElectronicMail>${this.xmlEscape(all.AcpContactElectronicMail)}</cbc:ElectronicMail>
		  </cac:Contact>  
		  ${acpfirtsAndfamliy}
		</cac:Party>
	  </cac:AccountingCustomerParty>
		...
		<cac:Party>
		  <cac:PartyIdentification>
			<cbc:ID schemeID="${this.xmlEscape(all.bcpSchemeID)}">${this.xmlEscape(all.bcpID)}</cbc:ID>
		  </cac:PartyIdentification>
		  <cac:PartyName>
			<cbc:Name>${this.xmlEscape(all.bcpName)}</cbc:Name>
		  </cac:PartyName>
		  <cac:PostalAddress>
			<cbc:StreetName>${this.xmlEscape(all.bcpPostalAddressStreetName)}</cbc:StreetName>
			<cbc:BuildingName/>
			<cbc:BuildingNumber/>
			<cbc:CitySubdivisionName/>
			<cbc:CityName>${this.xmlEscape(all.bcpCityName)}</cbc:CityName>
			<cac:Country>
			  <cbc:Name>${this.xmlEscape(all.bcpCountryName)}</cbc:Name>
			</cac:Country>
		  </cac:PostalAddress>
		  <cac:PartyTaxScheme>
			<cac:TaxScheme>
			  <cbc:Name>${this.xmlEscape(all.bcpPartyTaxSchemeName)}</cbc:Name>
			</cac:TaxScheme>
		  </cac:PartyTaxScheme>
		  <cac:PartyLegalEntity>
			<cbc:RegistrationName>${this.xmlEscape(all.bcpPartyLegalEntityRegistrationName)}</cbc:RegistrationName>
			<cbc:CompanyID>${this.xmlEscape(all.bcpPartyLegalEntityCompanyID)}</cbc:CompanyID>
		  </cac:PartyLegalEntity>
		</cac:Party>
	  </cac:BuyerCustomerParty>
  
	  <cac:PaymentMeans>
	  <cbc:PaymentMeansCode>${this.xmlEscape(all.pmCode)}</cbc:PaymentMeansCode>
	  <cac:PayeeFinancialAccount>
		<cbc:ID>${this.xmlEscape(all.pmIban)}</cbc:ID>
		<cbc:CurrencyCode>${this.xmlEscape(all.currencyID)}</cbc:CurrencyCode>
		<cac:FinancialInstitutionBranch>
		  <cbc:Name>${this.xmlEscape(all.pmBranch)}</cbc:Name>
		  <cac:FinancialInstitution>
			<cbc:Name>${this.xmlEscape(all.pmBank)}</cbc:Name>
		  </cac:FinancialInstitution>
		</cac:FinancialInstitutionBranch>
	  </cac:PayeeFinancialAccount>
	</cac:PaymentMeans>
		...
		if (all.pmDate != undefined) {
		  pmDates = `
			<cac:PaymentMeans>
			  <cbc:PaymentMeansCode>${this.xmlEscape(all.pmCode)}</cbc:PaymentMeansCode>
			  <cbc:PaymentDueDate>${this.xmlEscape(all.pmDate)}</cbc:PaymentDueDate>
			</cac:PaymentMeans>
		  `
		} else {
		  pmDates = ``
		...
		if (all.currencyID != 'TRY') {
		  ...
		  <cbc:SourceCurrencyCode listAgencyName="United Nations Economic Commission for Europe" listID="ISO 4217 Alpha" listName="Currency" listVersionID="2001">${this.xmlEscape(all.currencyID)}</cbc:SourceCurrencyCode>
		  ...
		  <cbc:CalculationRate>${this.xmlEscape(all.exchangeRate)}</cbc:CalculationRate>
		</cac:PricingExchangeRate>
		`
		} else {
		  dovizKod = ''
		...
		for (let i = 0; i < kdvParse.TaxSubtotal.length; i++) {
		  ...
		  let taxSub;
		  if (all.InvoiceTypeCode == 'ISTISNA' || all.InvoiceTypeCode == 'OZELMATRAH' || all.InvoiceTypeCode == 'IHRACKAYITLI' || all.InvoiceTypeCode == 'IADEISTISNA' || all.ProfileID == "IHRACAT") {
			...
			taxSub = `
			  ...
			  <cac:TaxCategory>
				<cbc:TaxExemptionReasonCode>${this.xmlEscape(all.TaxExemptionReasonCode)}</cbc:TaxExemptionReasonCode>
				<cbc:TaxExemptionReason>${this.xmlEscape(all.TaxExemptionReason)}</cbc:TaxExemptionReason>
				<cac:TaxScheme>
				  <cbc:Name>${this.xmlEscape(element.tcName)}</cbc:Name>
				  <cbc:TaxTypeCode>${this.xmlEscape(element.tcTaxTypeCode)}</cbc:TaxTypeCode>
				</cac:TaxScheme>
			  </cac:TaxCategory>
			</cac:TaxSubtotal>
			  `
			...
			let wttCode = `
			  <cac:WithholdingTaxTotal>
				...
				<cac:TaxSubtotal>
				  ...
				  <cac:TaxCategory>
					<cac:TaxScheme>
					  <cbc:Name>${this.xmlEscape(element.wttTaxCategoryTaxSchemeName)}</cbc:Name>
					  <cbc:TaxTypeCode>${this.xmlEscape(element.wttTaxCategoryTaxSchemeTaxTypeCode)}</cbc:TaxTypeCode>
					</cac:TaxScheme>
				  </cac:TaxCategory>
				</cac:TaxSubtotal>
			  </cac:WithholdingTaxTotal>
			`
			tevkifatArrWtt.push(wttCode)
		  }
		}
		  ...
		  for (let iad = 0; iad < iadeInfo.length; iad++) {
			...
			let iade = `
			  ...
			  <cac:InvoiceDocumentReference>
				<cbc:ID>${this.xmlEscape(element.iadeInvoiceDocumentReferenceID)}</cbc:ID>
				<cbc:IssueDate>${this.xmlEscape(element.iadeInvoiceDocumentReferenceIssueDate)}</cbc:IssueDate>
		...
		for (let i = 0; i < lineList.length; i++) {
		  ...
		  const itemXml = this.buildItemXml(lines);
		  ...
		  if (lines.IskChargeIndicator != undefined) {
			...
			<cbc:AllowanceChargeReason>${this.xmlEscape(lines.IskAllowanceChargeReason)}</cbc:AllowanceChargeReason>
			<cbc:MultiplierFactorNumeric>${lines.IskMultiplierFactorNumeric / 100}</cbc:MultiplierFactorNumeric>
			...
			<cac:TaxCategory>
			<cac:TaxScheme>
			<cbc:Name>${this.xmlEscape(lines.TaxSchemeName)}</cbc:Name>
			<cbc:TaxTypeCode>${this.xmlEscape(lines.TaxTypeCode)}</cbc:TaxTypeCode>
			</cac:TaxScheme>
			</cac:TaxCategory>
			</cac:TaxSubtotal>
			</cac:TaxTotal>
  
			${all.InvoiceTypeCode == 'TEVKIFAT' ?
				`<cac:WithholdingTaxTotal>
			  <cbc:TaxAmount currencyID=${JSON.stringify(all.currencyID)}>${lines.TevkifatWithholdingTaxTotalTaxableAmount}</cbc:TaxAmount>
			  <cac:TaxSubtotal>
			  <cbc:TaxableAmount currencyID=${JSON.stringify(all.currencyID)}>${lines.TevkifatWithholdingTaxTotalTaxAmount}</cbc:TaxableAmount>
			  <cbc:TaxAmount currencyID=${JSON.stringify(all.currencyID)}>${lines.TevkifatWithholdingTaxTotalTaxAmount2}</cbc:TaxAmount>
			  <cbc:Percent>${lines.TevkifatWithholdingTaxTotalPercent}</cbc:Percent>
			  <cac:TaxCategory>
			  <cac:TaxScheme>
			  <cbc:Name>${this.xmlEscape(lines.TevkifatWithholdingTaxTotalName)}</cbc:Name>
			  <cbc:TaxTypeCode>${this.xmlEscape(lines.TevkifatWithholdingTaxTotalTaxTypeCode)}</cbc:TaxTypeCode>
			  </cac:TaxScheme>
			  </cac:TaxCategory>
			  </cac:TaxSubtotal>
			  </cac:WithholdingTaxTotal>` : ``}
		  ...
		  } else if (lines.DlDeliveryTermsID != undefined) {
			...
			<cac:DeliveryTerms>
			<cbc:ID schemeID="INCOTERMS">${this.xmlEscape(lines.DlDeliveryTermsID)}</cbc:ID>
			</cac:DeliveryTerms>
			<cac:Shipment>
			<cbc:ID/>
			<cbc:FreeOnBoardValueAmount currencyID=${JSON.stringify(all.currencyID)}>${lines.DlFreeOnBoardValueAmount}</cbc:FreeOnBoardValueAmount>
			<cac:GoodsItem>
			<cbc:RequiredCustomsID>${this.xmlEscape(lines.DlRequiredCustomsID)}</cbc:RequiredCustomsID>
			</cac:GoodsItem>
			<cac:ShipmentStage>
			<cbc:TransportModeCode>${this.xmlEscape(lines.DlTransportModeCode)}</cbc:TransportModeCode>
			</cac:ShipmentStage>
			<cac:TransportHandlingUnit>
			<cac:ActualPackage>
			<cbc:ID/>
			<cbc:Quantity>${lines.DlQuantity}</cbc:Quantity>
			<cbc:PackagingTypeCode>${this.xmlEscape(lines.DlPackagingTypeCode)}</cbc:PackagingTypeCode>
			</cac:ActualPackage>
			</cac:TransportHandlingUnit>
			</cac:Shipment>
			</cac:Delivery>
		...
		let pushInv;
		if (all.InvoiceTypeCode == 'TEVKIFAT') {
		  pushInv = start + DespatchDocumentReferenceDate.join('') + orderReferenceXml + stb + xslt + stb2 + Signature + AccountingSupplierParty + AccountingCustomerParty + pmDates + BuyerCustomerParty + dovizKod + kdv + tevkifatArrWtt.join('') + total + daf.join('') + end
		} else if (all.InvoiceTypeCode == 'SATIS') {
		  pushInv = start + DespatchDocumentReferenceDate.join('') + orderReferenceXml + stb + xslt + stb2 + Signature + AccountingSupplierParty + AccountingCustomerParty + pmDates + BuyerCustomerParty + dovizKod + kdv + total + daf.join('') + end
		} else if (all.InvoiceTypeCode == 'IADE') {
		  pushInv = start + iadeCode.join('') + DespatchDocumentReferenceDate.join('') + orderReferenceXml + stb + xslt + stb2 + Signature + AccountingSupplierParty + AccountingCustomerParty + pmDates + BuyerCustomerParty + dovizKod + kdv + total + daf.join('') + end
		  ...
		  <soapenv:Header/>
				  <soapenv:Body>
					  <wsdl:SendInvoiceRequest>
						  <REQUEST_HEADER>
							  <SESSION_ID>${this.xmlEscape(all.SESSION_ID)}</SESSION_ID>
		...
		if (parseData.Envelope.Body.SendInvoiceResponse.ERROR_TYPE != undefined) {
		  ...
		  return response.status(400).send({
			status: 400,
			message: parseData.Envelope.Body.SendInvoiceResponse.ERROR_TYPE.ERROR_SHORT_DES.text,
			response: parseData.Envelope.Body.SendInvoiceResponse.ERROR_TYPE.ERROR_SHORT_DES.text
		  })
		  ...
		  return response.status(200).send({
			status: 200,
			message: 'OK',
			response: parseData.Envelope.Body.SendInvoiceResponse.REQUEST_RETURN
		  })
		}
		...
		let toJ = JSON.parse(resp)
  
		return response.status(400).send({
		  status: 400,
		  message: 'OK',
		  response: toJ.Envelope.Body.SendInvoiceResponse.REQUEST_RETURN
		})
	  }
	}
  
	public async eSorgu(SESSION_ID, vknTcknn) {
	  ...
	  <soapenv:Body>
		 <wsdl:CheckUserRequest>
			<REQUEST_HEADER>
				  <SESSION_ID>${this.xmlEscape(SESSION_ID)}</SESSION_ID>
				  <APPLICATION_NAME>S</APPLICATION_NAME>
			</REQUEST_HEADER>
			<USER>
			  <IDENTIFIER>${this.xmlEscape(vknTcknn)}</IDENTIFIER>
			</USER>
	  ...
	  `
		...
		let eSorgu = Object.keys(parseData.textEnvelope.textBody.textCheckUserResponse).length
	...
	public async sizeKesilenFaturalar({
	  response,
	  request
	}: HttpContextContract) {
	  ...
	  try {
		...
		console.log('sizeKesilenFaturalar -----> error ---->', error)
	  }
	}
  
	public async faturaNoGetir({ response, request }) {
	  try {
		const all = request.body()
		const faturaYil = all.yil
  
		const pageSize = 1000
		const baseUrl = 'https://api.izibiz.com.tr/v1/einvoices/outbox'
		const headers = { Authorization: 'Bearer ' + all.SESSION_ID }
  
		const firstConfig = {
		  method: 'get',
		  maxBodyLength: Infinity,
		  url: `${baseUrl}?page=0&pageSize=${pageSize}&sortProperty=createDate&sort=desc`,
		  headers
		}
  
		const firstRs = await axios.request(firstConfig)
  
		const firstData = firstRs.data?.data
		const firstContents = firstData?.contents || []
		const pageable = firstRs.data?.pageable || firstData?.pageable
  
		const totalPages =
		  pageable?.totalPages ??
		  firstData?.pageable?.totalPages ??
		  1
  
		let allFaturalar = [...firstContents]
		...
		if (totalPages > 1) {
		  for (let p = 1; p < totalPages; p++) {
			const cfg = {
			  method: 'get',
			  maxBodyLength: Infinity,
			  url: `${baseUrl}?page=${p}&pageSize=${pageSize}&sortProperty=createDate&sort=desc`,
			  headers
			}
  
			const rs = await axios.request(cfg)
			const data = rs.data?.data
			const contents = data?.contents || []
  
			allFaturalar = allFaturalar.concat(contents)
		  }
		}
  
		for (let i = 0; i < allFaturalar.length; i++) {
		  const element = allFaturalar[i]
		  if (!element?.documentNo) continue
  
		  const chk = element.documentNo.indexOf(all.SERI_NO)
		  const chk2 = element.documentNo.indexOf(String(faturaYil))
  
		  if (chk > -1 && chk2 > -1) {
			const nextNo =
			  parseInt(element.documentNo.split(all.SERI_NO)[1], 10) + 1
  
			return response.status(200).send({
			  status: 200,
			  message: 'OK',
			  response: { faturaNo: nextNo }
			})
		  }
		}
		...
		return response.status(200).send({
		  ...
		  message: 'OK',
		  response: {
			faturaNo: parseInt(`${faturaYil}000000001`, 10)
		  }
		})
	  } catch (error) {
		return response.status(200).send({
